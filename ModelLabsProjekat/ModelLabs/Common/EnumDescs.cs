...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			...
			property2enumType.Add(ModelCode.BIS_VALUE1MULTIPLIER, typeof(UnitMultiplier));
			property2enumType.Add(ModelCode.BIS_VALUE2MULTIPLIER, typeof(UnitMultiplier));
			property2enumType.Add(ModelCode.BIS_VALUE1UNIT, typeof(UnitSymbol));
			property2enumType.Add(ModelCode.BIS_VALUE2UNIT, typeof(UnitSymbol));
