    ...
    public class BasicIntervalSchedule : IdentifiedObject
    {
        ...
        public override bool Equals(object x)
        {
            if (base.Equals(x))
            {
                ...
                return (b.startTime == this.startTime && b.value1Multiplier == this.value1Multiplier && b.value1Unit == this.value1Unit &&
                    b.value2Multiplier == this.value2Multiplier && b.value2Unit == this.value2Unit);
            }
            else return false;
        }
